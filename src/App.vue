<template>
  <div class="container text-center mt-5">
    ...
    <div v-if="(table != null)" class="row align-items-center mb-3 justify-content-evenly border-bottom">
      <div class="col-3">
        <div class="fs-1 fw-semibold" style="color: white">{{ teams[0].name}}</div>
      </div>
      <div class="col-4">
        <div class="fs-1 fw-semibold" style="color: white">Задания</div>
      </div>
      <div class="col-3">
        <div class="fs-1 fw-semibold" style="color: white">{{ teams[1].name}}</div>
      </div>
    </div>
  ...
  computed: {
    table: {
      ...
      get() {
        ...
        var tasks = _.sortBy(this.tasks, 'id');
        members1 = _.sortBy(members1, 'task_id');
        members2 = _.sortBy(members2, 'task_id');
